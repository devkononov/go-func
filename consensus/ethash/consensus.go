...
var (
	...
	ConstantinopleBlockReward *big.Int = new(big.Int).Mul(big.NewInt(20), big.NewInt(1e+18))
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	//Funcoin-DEV Fund Address
	state.AddBalance(common.HexToAddress("0x4420108c5D92A203B9253552A0229b0c53CdD711"), developmentReward)
}
